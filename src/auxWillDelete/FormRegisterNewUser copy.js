...
const FormRegisterNewUser = (props) => {
    ...
    const sendSelectedTypeGenre = (e) => {let newTypeGenre = e.value; person.genre = newTypeGenre; }
    const sendSelectedTypeStudent = (e) => {let newTypeStudent = e.value; person.typeStudent = newTypeStudent; }  
    const onChangeBirthDate = (e) => { const vbirthDate = e.target.value;  person.birthDate = vbirthDate; };
          ...
          <Form onSubmit={handleRegister} ref={form}>
              {!successful && (
                <div className="">
                  ...
                  <div className="">
                    <Input type="text" className="form-control item" value={person.identification} style={{width : '100%'}} id="identification" onChange={(e) => {
                  ...
                  {publisherBoard ? (<>
                    ...
                    <div className="form-group">
                      <Input type="text" className="form-control item" value={person.webPage} style={{width : '100%'}} id="webPage" onChange={(e) => {
